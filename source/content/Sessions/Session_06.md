...
- Pirates found frozen in ice throughout the ship
- [[Jaspar_Starshade|Jaspar]] placed floating devices on frozen pirates (in case they're unfrozen later)
- Captain's cabin contained a treasure map with multiple X's and one unmarked island ([[Milo_Swiftclock|Milo]] marked it with an O)

### Dependable Defenses
**Selling Loot:**
- Party sold a [[Moonstone_Mask|moonstone]] for 190 gp
- [[Modred_De_Moray|Modred]] threatened to tell guards the shopkeeper deals with pirates
...
- Ice spikes from the ring destroyed the carriage
...
- Party had to sneak past the dragon
- [[Auren]] ran so fast the dragon didn't see him
- [[Modred_De_Moray|Modred]] slipped through between frozen dwarves
- [[Jaspar_Starshade|Jaspar]] (the rogue) was noticed and hit by the dragon but survived
- [[Milo_Swiftclock|Milo]] managed to slip by unseen
- Party closed the gate and reached safety inside

## Loot Acquired

| Item | Description | Holder |
|------|-------------|--------|
| Pirate Hat | Found in deck chest | [[Milo_Swiftclock|Milo]] |
| 100 gp | Found in deck chest | Party |
| [[Moonstone_Mask|moonstone]] | Found in captain's cabin container | Sold (190 gp) |
| [[Moonstone_Mask|moonstone]] | Found in broken cabinet | Party |
| Treasure Map | Shows islands with X's, one unmarked (marked with O by [[Milo_Swiftclock|Milo]]) | [[Milo_Swiftclock|Milo]] |
...
1. **Morning at [[The_Thirsty_Goat|the Thirsty Goat]]** - [[Brost]] makes breakfast, mentions the election
2. **Pirate Ship Expedition** - Party decides to loot the frozen ship for money
3. **Anchor Ascent** - [[Auren]] uses Misty Step to reach anchor, lowers it for others
4. **Deck Discovery** - Found chest with pirate hat and 100 gp
5. **Cargo Hold Exploration** - [[Milo_Swiftclock|Milo]] and Tock investigate below deck
6. **Captain's Cabin** - Found frozen captain pointing at map, took the treasure map
7. **Cabinet Breaking** - [[Modred_De_Moray|Modred]] broke locked cabinet, found second [[Moonstone_Mask|moonstone]] amid rum spillage
8. **Return to City** - Climbed down anchor and headed back
9. **Gift for [[Brost]]** - Gave him 2 rum bottles, asked about selling moonstones
10. **[[Moonstone_Mask|Moonstone]] Sale** - Sold one [[Moonstone_Mask|moonstone]] at armor shop for 190 gp (with threatening persuasion)
...
- [[Milo_Swiftclock|Milo]]: Got a pirate hat, marked the [[Mysterious_Shrine_Chest|mysterious]] island on the treasure map, sent Tock to scout ahead
- [[Modred_De_Moray|Modred]]: Used intimidation tactics to get better price for [[Moonstone_Mask|moonstone]]
- [[Jaspar_Starshade|Jaspar]]: Showed compassion by putting flotation devices on frozen pirates; ironically the rogue was the one spotted by the dragon
- [[Auren]]: Demonstrated acrobatic excellence with Misty Step and anchor climbing; outran the dragon's notice

**Mechanical Notes:**
- [[Auren]]'s Misty Step was key to accessing the frozen ship
- [[Jaspar_Starshade|Jaspar]] failed his stealth check against the dragon
- [[Milo_Swiftclock|Milo]] succeeded on stealth despite following after [[Jaspar_Starshade|Jaspar]]'s failed attempt
- The freeze wave was a environmental hazard that destroyed property
