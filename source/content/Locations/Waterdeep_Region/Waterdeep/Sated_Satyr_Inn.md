...
## Description
A fancy inn in Waterdeep, comparable in quality to Neverwinter's Moonstone Mask. Multiple floors with a busy atmosphere. Despite the name, the owner Tibon is actually human (not a satyr). The inn serves as the party's primary base of operations in Waterdeep. Known for quality stew and evening entertainment with live music.

## Notable Features

### Common Room
- Multiple floors
- Busy atmosphere with live music in evenings
- Dining area with waiters
- Masquerade poster prominently displayed
- Card tables where nobles gamble
- Specialty: "Really good stew"
